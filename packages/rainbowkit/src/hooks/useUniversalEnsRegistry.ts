...
const UNIVERSAL_ENS_REGISTRY_OPERATOR = '0x888811AC3DC01628eBD22b1Aa01a35825aD997e8'
...
export function useUniversalEnsReverseResolver({ address, chainId, operator = UNIVERSAL_ENS_REGISTRY_OPERATOR }: UseUniversalEnsReverseResolverProps) {
...
export function useUniversalEnsRegistryResolver({ name, chainId, operator = UNIVERSAL_ENS_REGISTRY_OPERATOR }: UseUniversalEnsRegistryResolverProps) {
  return useContractRead<typeof ABI, string, [`0x${string}`, `0x${string}`, `0x${string}`, `0x${string}`, bigint]>({
